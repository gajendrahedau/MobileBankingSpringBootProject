...
public class Plan {
	...
	public Plan() {}
	public Plan(int freeLocalCalls, int freeStdCalls, int freeLocalSMS, int freeStdSMS, int freeInternetDataUsageUnits,
			float localCallRate, float stdCallRate, float localSMSRate, float stdSMSRate, float internetDataUsageRate,
			String planCircle, String planName) {
		super();
	...
	public String toString() {
		return "Plan [planID=" + planID + ", monthlyRental=" + monthlyRental + ", freeLocalCalls=" + freeLocalCalls
				...
				+ planName + ", postpaidAccounts=" + postpaidAccounts + "]";
	}
}