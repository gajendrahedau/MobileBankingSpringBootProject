...
public class Customer {
	@Id
	@SequenceGenerator(name="customerSeq1",initialValue=4444,allocationSize=1,sequenceName="customerSeq1")
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="customerSeq1") //
