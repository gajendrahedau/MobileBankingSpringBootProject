...
public class Bill {
	@Id
	@SequenceGenerator(name="billSeq2",initialValue=6935612,allocationSize=1,sequenceName="billSeq2")
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="billSeq2"	)//
	private int billID;
	...
	public Bill(float totalBillAmount, float localSMSAmount, float stdSMSAmount, float localCallAmount,
			float stdCallAmount, float internetDataUsageAmount, float servicesTax, PostpaidAccount postpaidAccount) {
		super();
		this.totalBillAmount = totalBillAmount;
		this.localSMSAmount = localSMSAmount;
		this.stdSMSAmount = stdSMSAmount;
